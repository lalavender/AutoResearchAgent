...
## 工具层 ✅
- [x] agent/tools/tavily_search.py — Tavily 搜索集成
...
- [x] 内容截断优化 — 200000 字符
- [x] 搜索并发优化 — asyncio.to_thread
- [x] Gap 搜索批处理
- [x] 每轮问题数 10 个
- [x] 目录结构优化 — backend/ 目录

## 提示词优化 ✅
- [x] PLANNING_PROMPT — 8 维度覆盖，10-20 个子任务
- [x] TIER1_SEARCH_PROMPT — 全面深入回答
- [x] EXTRACT_PROMPT — 5-10 个关键发现提取
- [x] GAP_ANALYSIS_PROMPT — 5 维度评估
- [x] REPORT_PROMPT — 7 章节结构，6000-10000 字
